...
const ParticleCard = ({
  ...
  return (
    ...
    >
      {bgImage && (
        <>
          <div className="magic-bento-card__bg" style={{ backgroundImage: `url(${bgImage})` }} />
          <div className="magic-bento-card__overlay" />
        </>
      )}
      <div style={{ position: 'relative', zIndex: 10, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
          {children}
      </div>
    </div>
  );
