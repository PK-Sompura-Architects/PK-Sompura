...
// /admin to the backend (see netlify.toml), so a relative base is correct and
// avoids a CORS preflight. Only local development needs an absolute origin,
// and VITE_API_BASE_URL overrides both when a deploy talks to a backend on a
// different host.
//
